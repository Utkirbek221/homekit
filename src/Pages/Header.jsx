    ...
    <div id='#header'
      ...
      <div className={` flex justify-between items-center w-full  ${isScrolled ? 'p-[8px_7vw] max-md:p-[5px_5vw]' : 'p-[5px_7vw] max-md:p-[25px_5vw]'
        ...
        <div className='max-md:hidden flex justify-between items-center w-[50%] max-lg:text-[12px] text-[14px]'>
          <a className='hover:text-[#000] hover:bg-[#fff] rounded-[5px] p-2 duration-500 cursor-pointer' href="#service">{t('header.main')}</a>
          <a className='hover:text-[#000] hover:bg-[#fff] rounded-[5px] p-2 duration-500 cursor-pointer' href="#aboute">{t('header.about')}</a>
          <a className='hover:text-[#000] hover:bg-[#fff] rounded-[5px] p-2 duration-500 cursor-pointer' href="#registor">{t('header.services')}</a>
        </div>
        <div className='max-md:hidden flex justify-between items-center'>
          <select
            className='bg-[#ffffff30] border-t-[1px] border-[#ffffff7f] rounded-[3px] p-[2px_5px] text-[14px] mr-[30px]  hover:text-[#000] hover:bg-[#fff] duration-500 cursor-pointer'
          ...
          <a href="#registor" className='bg-[#b50a3f] cursor-pointer text-white flex flex-col items-center justify-center gap-[5px] p-[8px_15px] rounded-[10px] text-[14px] max-lg:text-[12px]'>
        ...
        >
          <div className='flex flex-col gap-5 text-[#D4D4D8] p-5 w-full'>
            ...
            <div className='flex flex-col mt-[30px] justify-center items-center text-[18px] text-[#fff] gap-[80px]'>
              <a onClick={toggleMenu} href="#service">{t('header.main')}</a>
              <a onClick={toggleMenu} href="#aboute">{t('header.about')}</a>
              <a onClick={toggleMenu} href="#registor">{t('header.services')}</a>
              <p className='leading-[17px]'>+998 97 777 29 29</p>
              <select
